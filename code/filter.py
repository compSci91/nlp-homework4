...
class Filter:
    def filter_training_files(self, unfiltered_training_files):
        ...
        for file_path in unfiltered_training_files:
            ...
            if self.numberOfHits('excellent', file_contents) >= 1 or self.numberOfHits('poor', file_contents) >= 1:
                print "Found a file with excellent or poor!"
